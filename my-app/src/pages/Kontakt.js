...
const Kontakt = () => {
    ...
    const form = useRef();
    const [isSent, setIsStent] = useState(false)

  const sendEmail = (e) => {
    e.preventDefault();

    emailjs
      .sendForm('ffabijanTest', 'template_xwjd18p', form.current, {
        publicKey: 'zqBtlX9L321aA5cGZ',
      })
      .then(
        () => {
          console.log('SUCCESS!');
          ...
          <div className="row my-4">
            ...
            <div className="col-md-8 contact-right">
              <div className="d-flex flex-column contact-inputs">
                  ...
                  <form ref={form} onSubmit={sendEmail} className='d-flex flex-column contact-inputs'>
